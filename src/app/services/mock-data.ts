import { Dashboard, Report, Heatmap, MetricTile, View, Field, ContentUserRole } from '../models/content.models';
...
// ── Heatmaps (3) ─────────────────────────────────────
export const MOCK_HEATMAPS: Heatmap[] = [
  { id: 'h1', name: 'Compensation Overview',        description: 'Salary distribution across the organization', viewId: 'v2', fieldIds: ['f1', 'f2', 'f3', 'f9', 'f10', 'f11'], company: 'Global Industries' },
  { id: 'h2', name: 'Performance Ratings',          description: 'Performance review scores by department',     viewId: 'v4', fieldIds: ['f2', 'f3', 'f17', 'f18'], company: 'NextGen Ltd' },
  { id: 'h3', name: 'Talent Assessment Matrix',     description: 'Performance vs potential 9-box grid',         viewId: 'v4', fieldIds: ['f2', 'f3', 'f17', 'f20'], company: 'Global Industries' },
];

// ── Metric Tiles (1) ─────────────────────────────────
export const MOCK_METRIC_TILES: MetricTile[] = [
  { id: 'mt1', name: 'Salary Band Analysis', description: 'Pay grade distribution and outliers', viewId: 'v2', fieldIds: ['f2', 'f3', 'f4', 'f9', 'f11', 'f12'], company: 'Global Industries' },
];
...
export const MOCK_DASHBOARDS: Dashboard[] = [
  ...
  { id: 'd2', name: 'Compensation Dashboard', description: 'Compensation analytics and pay equity',        reportIds: [] },
  { id: 'd3', name: 'Absence Dashboard',      description: 'Absence trends and leave management',          reportIds: ['r6', 'r7'] },
  { id: 'd4', name: 'Performance Dashboard',  description: 'Performance management and talent assessment', reportIds: ['r9'] },
];
